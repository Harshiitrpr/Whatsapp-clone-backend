...
import com.harshwkumar.whatsapp_clone_backend.messaging.domain.user.aggregate.AuthorityBuilder;
...
public class AuthorityEntity {
    ...
    public static Set<AuthorityEntity> from(Set<Authority> authorities) {
        return authorities
                .stream()
                .map(authority ->
                        com.harshwkumar.whatsapp_clone_backend.infrastructure.secondary.entity.AuthorityEntityBuilder.authorityEntity()
